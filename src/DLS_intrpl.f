...
!     &           ,KN,grid,RN,RK,WL)
        call USU_LS(RATIO,NRATN
     &           ,KN1,grid1,WAVEL,KRE,KIM,ARE,AIM)

!!!!!       write  Zdes dobav pechat US22
	   else
       call USU_LS_RD(RATIO,NRATN
     &           ,KN1,grid1,WAVEL,KRE,KIM,ARE,AIM)
...
!c****************************************************************
      ...
      use alloc 
      USE mo_par_DLS
      use mo_DLS, only : keyEL,keySUB,keyLS
     &                  ,KM,ANGLE,KN,grid,RN,RK,WL
!	  use mod_os
...
!c **************************************************************** 
      SUBROUTINE USU_LS(RATIO,NRATN
     &                 ,KN1,grid1,WAVEL,KRE,KIM,ARE,AIM) 
      use alloc1
      USE mo_par_DLS
      use mo_DLS, only : key_RD,keyEL,keySUB,keyLS
     &                  ,KR,R,RD,KM,ANGLE,KN,grid,RN,RK,WL
!	  use mod_os
	  use mo_intrpl_spline
		use mo_intrpl_linear
...
!c **************************************************************** 
      SUBROUTINE USU_LS_RD(RATIO,NRATN
     &                 ,KN1,grid1,WAVEL,KRE,KIM,ARE,AIM) 
      use alloc1
      USE mo_par_DLS
      use mo_DLS, only : key_RD,keyEL,keySUB,keyLS
